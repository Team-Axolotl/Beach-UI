                ...
                <Row className={style.padRow} justify='center'>
                        <Row className={style.padRow} justify='center'>
                            <Col md={5} xs={12} sm={10}>
                                ...
                                <StandardInput fullWidth onChange={this.props.applyInput} data={'userName'} value={this.props.inputs['userName'] || ''} translateLabel error={this.props.errors['userName'] || ''} />
                            </Col>
                        </Row>
                        <Row className={style.padRow} justify='center'>
                            <Col md={5} xs={12} sm={10}>
                                <Translate>{'Password'}</Translate>
                                <StandardInput fullWidth onChange={this.props.applyInput} type='password' data={'password'} value={this.props.inputs['password'] || ''} translateLabel error={this.props.errors['password'] || ''} />
                            </Col>
                        </Row>
                </Row>
            </div>
